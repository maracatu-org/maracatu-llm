...
echo "    Upload HF:"
echo "      huggingface-cli upload maracatu-labs/${MODEL_NAME} ${GGUF_Q4} gguf/${MODEL_NAME}-Q4_K_M.gguf"
echo "      huggingface-cli upload maracatu-labs/${MODEL_NAME} ${GGUF_Q5} gguf/${MODEL_NAME}-Q5_K_M.gguf"
echo "      huggingface-cli upload maracatu-labs/${MODEL_NAME} ${GGUF_Q8} gguf/${MODEL_NAME}-Q8_0.gguf"
echo ""
echo "    Ollama (ajustar path no Modelfile antes):"
echo "      ollama create whereisanzi/${MODEL_NAME} -f Modelfile"
echo "      ollama push whereisanzi/${MODEL_NAME}"
echo "============================================================"
